...
Polygon_with_holes_2 get_minkowski_1(Polygon_2 p, Polygon_2 q)
{
    return CGAL::minkowski_sum_2(p, q);
}

Polygon_with_holes_2 get_minkowski_2(Polygon_with_holes_2 p, Polygon_2 q)
{
    Ptd decomposition1;
    Sabd decomposition2;
    return CGAL::minkowski_sum_2(p, q, decomposition1, decomposition2);
...
Polygon_with_holes_2 get_minkowski_3(Polygon_2 p, Polygon_with_holes_2 q)
{
    Sabd decomposition1;
    Ptd decomposition2;
    return CGAL::minkowski_sum_2(p, q, decomposition1, decomposition2);
...
Polygon_with_holes_2 get_minkowski_4(Polygon_with_holes_2 p, Polygon_with_holes_2 q)
{
    Ptd decomposition1;
    Ptd decomposition2;
    return CGAL::minkowski_sum_2(p, q, decomposition1, decomposition2);
